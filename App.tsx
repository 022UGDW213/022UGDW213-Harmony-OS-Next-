...
import AIReasonerIcon from './components/icons/AIReasonerIcon';
import SystemMonitorIcon from './components/icons/SystemMonitorIcon';

// App Content Imports
import AIReasonerContent from './components/apps/AIReasonerContent';
import SystemMonitorContent from './components/apps/SystemMonitorContent';
...
const appConfig: Record<string, AppConfigItem> = {
    // Commented out apps with missing icons - uncomment when icons are created
    ...
    // Active apps with implemented icons
    'AI Reasoner': { icon: AIReasonerIcon, content: AIReasonerContent, defaultSize: { width: 550, height: 600 } },
    'System Monitor': { icon: SystemMonitorIcon, content: SystemMonitorContent, defaultSize: { width: 500, height: 550 } },
};
